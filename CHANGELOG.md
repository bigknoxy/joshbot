...
- **MCP client** (#155) — stdio-transport Model Context Protocol servers configurable in `config.json`; discovered tools register into the normal tool registry, namespaced so an MCP server cannot shadow a built-in tool.
